...
export function EmptyState({ onBuildAgent }: EmptyStateProps) {
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center space-y-6 max-w-md">
        ...
        <Button onClick={onBuildAgent} size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90">
